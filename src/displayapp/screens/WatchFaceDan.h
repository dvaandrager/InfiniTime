...
namespace Pinetime {
  ...
  namespace Applications {
    namespace Screens {
      ...
      class WatchFaceDan : public Screen {
      public:
        WatchFaceDan(Controllers::DateTime& dateTimeController,
      ...
      private:
        ...
        lv_point_t line_icons_points[3] {{0, 5}, {230, 5}, {235, 0}};
//        lv_point_t line_day_of_week_number_points[4] {{0, 0}, {100, 0}, {95, 95}, {0, 95}};
        lv_point_t line_day_of_year_points[3] {{0, 5}, {235, 5}, {240, 0}};
        lv_point_t line_date_points[3] {{0, 5}, {235, 5}, {240, 0}};
    ...
    template <>
    struct WatchFaceTraits<WatchFace::Dan> {
      static constexpr WatchFace watchFace = WatchFace::Dan;
      static constexpr const char* name = "Dan";

      static Screens::Screen* Create(AppControllers& controllers) {
        return new Screens::WatchFaceDan(controllers.dateTimeController,
      ...
      static bool IsAvailable(Pinetime::Controllers::FS& filesystem) {
        return Screens::WatchFaceDan::IsAvailable(filesystem);
      }
    };
  }
}
